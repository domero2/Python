...
# Object of databricks class
firsdatabricks = Databricks()

# Object inheritance from Astronomer method astro_run() method responsible to return sysdate as last astro run
...
# Specjal method which allow printing length as amount of pages and string values from object
class Book():
...
#Mathematics class with method counting distance and slope
class Line():
...
# Example off bank account system
class Account():
